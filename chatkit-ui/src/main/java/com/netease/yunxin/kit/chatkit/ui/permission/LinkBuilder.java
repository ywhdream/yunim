...
public class LinkBuilder {
    ...
    private boolean enableLinkMovement = true;
    ...
    public LinkBuilder setEnableLinkMovement(boolean enableLinkMovement) {
        this.enableLinkMovement = enableLinkMovement;
        return this;
    }
