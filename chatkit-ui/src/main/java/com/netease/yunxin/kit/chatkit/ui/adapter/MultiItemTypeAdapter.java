...
import com.netease.yunxin.kit.chatkit.ui.util.ItemViewDelegateManager;
...
public class MultiItemTypeAdapter<T> extends RecyclerView.Adapter<ViewHolder> {
    ...
    public void addItemViewDelegate2(Object dynamicListBaseItem) {
        mItemViewDelegateManager.addDelegate((ItemViewDelegate) dynamicListBaseItem);
    }
